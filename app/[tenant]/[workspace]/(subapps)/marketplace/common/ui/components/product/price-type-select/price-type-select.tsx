...
export function PriceTypeSelect({currentPriceType}: PriceTypeSelectProps) {
  ...
  return (
    <select
      ...
      className="bg-white border border-ink-100 rounded-lg px-4 py-2 text-sm text-ink-900 cursor-pointer hover:border-royal transition-colors appearance-none pr-10 bg-no-repeat bg-right"
      style={{
