        ...
        'error',
        {
          paths: [
            ...
            },
            {
              ...
              message:
                'Hand-joining the base path is how it ends up missing or doubled. Use withBasePath for a path, absoluteRoot from @/url/absolute for an origin joined to the base path.',
            },
          ],
          patterns: [
            {
              group: ['@/lib/core/*'],
              message:
                'Every lib/core module has an alias in tsconfig.json: import it as @/<module>/… rather than @/lib/core/<module>/….',
            },
          ],
        },
      ],
