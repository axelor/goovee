 ...
 * through, and tenants.config.schema.json — generated by
 * `pnpm config:schema:generate`, and what an operator's editor validates the
 * document against. Adding a setting means adding it here and regenerating,
 * rather than writing it into a type, a check and a schema file that are free
 * to disagree.
 *
